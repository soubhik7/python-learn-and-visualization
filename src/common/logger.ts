...
export class Logger {
    ...
    private readonly _outputChannel = lazy(() => vscode.window.createOutputChannel('PythonVisualizer'));
    ...
    private readTrace(): Trace {
        return Trace.fromString(vscode.workspace.getConfiguration().get<string>('pythonVisualizer.trace', 'off'));
    }
}