    ...
    updateOutputFull(smoothTransition) {
        ...
        if (isLastInstr) {
            if (this.promptForUserInput || this.promptForMouseInput) {
                msg = '<b><font color="' + exports.brightRed + '">User input is not supported</font></b>';
...
class DataVisualizer {
    ...
    renderPrimitiveObject(obj, stepNum, d3DomElement) {
        var myViz = this; // to prevent confusion of 'this' inside of nested functions
...
class CodeDisplay {
    constructor(owner, domRoot, domRootD3, codToDisplay, lang, editCodeBaseURL) {
...
class NavigationController {
    ...
    setVcrControls(msg, isFirstInstr, isLastInstr) {
