...
require('./lib/jquery-ui-1.11.4/jquery-ui.min.js');
...
export var mdRed = '#cf6679'; // Material Design Red
export var mdPurple = '#bb86fc'; // Material Design Purple
export var mdBlue = '#3700b3'; // Material Design Blue
export var mdTeal = '#03dac6'; // Material Design Teal
export var lightOrange = '#f48771'; // light Orange
...
export var darkArrowColor = mdPurple;
export var lightArrowColor = mdTeal;
...
export class ExecutionVisualizer {
  ...
  render() {
    ...
    this.domRoot.find('#vizLayoutTdFirst').append(`<div id="codAndNav" style="width: ${this.params.width}px;"/>`);
  ...
  updateOutputFull(smoothTransition) {
    ...
    if (isLastInstr) {
      if (this.promptForUserInput || this.promptForMouseInput) {
        msg = '<b><font color="' + brightRed + '">User input is not supported</font></b>';
...
class CodeDisplay {
  ...
  constructor(owner, domRoot, domRootD3,
    ...
    if (lang !== undefined) {
      if (lang.substr(0, 6) === 'Python') {
        this.domRoot.find('#langDisplayDiv').html(lang);
      } else if (lang === 'js') {
  ...
  renderPyCodeOutput() {
    ...
    var codeOutputD3 = this.domRootD3.select('#pyCodeOutputDiv')
      ...
      //   }
      //   else {
      //     // Use highlight.js to highlight Python code
      //     return '<pre><code class="language-python">' + d.text + '</code></pre>';
      //   }
      // });
...
class NavigationController {
  ...
  constructor(owner, domRoot, domRootD3, nSteps) {
    ...
    var navHTML = '<div id="navControlsDiv">\
                   <div id="executionSlider"/>\
                   <div id="executionSliderFooter"/>\
                   <div id="vcrControls" style="margin-left: 0px;">\
                     <button id="jmpFirstInstr", type="button" style="margin-left: 0px; margin-right: 10px;">&lt;&lt; First</button>\
  ...
  hideUserInputDiv() {
    this.domRoot.find('#rawUserInputDiv') && this.domRoot.find('#rawUserInputDiv').hide();
  }

  showUserInputDiv() {
    this.domRoot.find('#rawUserInputDiv') && this.domRoot.find('#rawUserInputDiv').show();
  }
  ...
  setupSlider(maxSliderVal: number) {
    ...
    this.domRoot.find(".ui-widget-content").css('font-size', '9pt');
